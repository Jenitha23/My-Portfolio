...
function Hero() {
  return (
    <section id="top" className="hero">
      <div
        className="ambient-blob ambient-blob--float hero__blob hero__blob--accent"
        aria-hidden="true"
      />
      <div
        className="ambient-blob ambient-blob--float hero__blob hero__blob--teal"
        aria-hidden="true"
      />
      ...
      <div className="container hero__inner">
        ...
        >
          <Avatar src={profileImage} name={name} size="lg" />
        </motion.div>
